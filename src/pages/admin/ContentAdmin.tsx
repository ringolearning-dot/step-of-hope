...
const CONTENT_FIELDS: Record<string, ContentField[]> = {
  ...
  impact: [
    ...
    { page: 'impact', key: 'stat1_value', label: 'Stat 1 Value (e.g. 50+)', type: 'text' },
    { page: 'impact', key: 'stat1_label', label: 'Stat 1 Label (e.g. Children Supported)', type: 'text' },
    { page: 'impact', key: 'stat2_value', label: 'Stat 2 Value (e.g. 30+)', type: 'text' },
    { page: 'impact', key: 'stat2_label', label: 'Stat 2 Label (e.g. Hospital Visits)', type: 'text' },
    { page: 'impact', key: 'stat3_value', label: 'Stat 3 Value (e.g. 15+)', type: 'text' },
    { page: 'impact', key: 'stat3_label', label: 'Stat 3 Label (e.g. Birthdays Celebrated)', type: 'text' },
    { page: 'impact', key: 'stat4_value', label: 'Stat 4 Value (e.g. 500+)', type: 'text' },
    { page: 'impact', key: 'stat4_label', label: 'Stat 4 Label (e.g. Smiles Created)', type: 'text' },
    { page: 'impact', key: 'transparency_children_helped', label: 'Transparency — Children Helped', type: 'text' },
    { page: 'impact', key: 'transparency_events_organized', label: 'Transparency — Events Organized', type: 'text' },
  ],
  events: [
